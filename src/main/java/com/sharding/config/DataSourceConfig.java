...
import com.sharding.strategy.ModuloDatabaseShardingAlgorithm;
import com.sharding.strategy.ModuloTableShardingAlgorithm;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.sharding.mapper", sqlSessionTemplateRef  = "test1SqlSessionTemplate")
